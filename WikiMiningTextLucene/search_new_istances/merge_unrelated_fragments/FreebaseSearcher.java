...
public class FreebaseSearcher {
	...
	private static final String field = "mid";
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		System.out.println(searcher.getMapping(mid).getTypes());
		System.out.println(searcher.getMapping(mid).getKeywords());
		System.out.println(searcher.getMapping(mid).getWikid());
	}
