...
public class Printer {
	...
	public void PrintMention (PrintWriter out, WikiArticle wikiArticle){
		...
		while(i.hasNext()) {
			...
			out.println(me.getKey()+ "\t"+me.getValue().getKey()+"\t"+me.getValue().getValue().toString());
		}
	}
	public void PrintMentionMapping (PrintWriter out, WikiArticle wikiArticle){

		TreeMap<String, MappingObject> treemap = (TreeMap<String, MappingObject>) wikiArticle.getInfo_mentions();
		...
		while(keyIterator.hasNext()){
			String me = keyIterator.next();
			mapping = treemap.get(currentEntity);
			out.println("mapping: "+me+"\t");
		}
	}
