...
public class Configuration {
	...
	public Configuration(String configFilePath){
		...
		ip_elasticsearch =  props.getProperty("ip_elasticsearch").toString();
	}
	...
	/**
	 * @return the ip_elasticsearch
	 */
	public String getIp_elasticsearch() {
		return ip_elasticsearch;
	}


	/**
	 * @param ip_elasticsearch the ip_elasticsearch to set
	 */
	public void setIp_elasticsearch(String ip_elasticsearch) {
